...
import 'package:water_reminder/presentations/views/water_reminder/widgets/widgets.dart';
...
import 'package:water_reminder/utils/datetime_utils.dart';

import '../jsonview.dart';

class WaterReminderView extends StatelessWidget {
  WaterReminderView({Key? key}) : super(key: key);

  final controller = Get.put(WaterReminderController());
                      ...
                      Align(
                        child: GestureDetector(
                          ...
                          child: RoundedWaveWidget(
                            current: controller.getTodayRecord().totalCapacity,
